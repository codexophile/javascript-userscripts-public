...
<svg width="800px" height="800px" viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"
  ...
  <!-- Porthole / Window -->
  <circle cx="42.32" cy="21.44" r="5.48" fill="#118AB2" />
  
  <!-- Window Glare / Shine (Added for extra detail) -->
  <circle cx="40.5" cy="19.5" r="1.5" fill="#FFFFFF" stroke="none" />
  
  <!-- Bottom Fin -->
  <path d="M30.61,43.16,30,47.84a.24.24,0,0,0,.33.25l8-3.47A2.32,2.32,0,0,0,39.63,43l1.22-5.83" fill="#EF476F" />
  
  <!-- Top Fin -->
  <path d="M20,33.29l-4.69.6a.23.23,0,0,1-.24-.32l3.46-7.95a2.33,2.33,0,0,1,1.67-1.35l5.82-1.22" fill="#EF476F" />
  
  <!-- Exhaust Flame -->
  <path d="M21.49,36.68c-6.55,2.1-6.88,12.47-6.88,12.47s10.08.11,12.59-6.76" fill="#FF9F1C" />
